  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | PERE DEL CASO BARBERSHOP</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop PERE DEL CASO BARBERSHOP in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="PERE DEL CASO BARBERSHOP | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="PERE DEL CASO BARBERSHOP | Premium Barbershop Berlin" />
        <meta
